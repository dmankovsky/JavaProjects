...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        BasicHamburger BasicHamburger = new BasicHamburger("Basic", "Bacon",3.50,"White");
        BasicHamburger.itemizeHamburger();
        BasicHamburger.addAddition1("tomato",0.60);
        BasicHamburger.addAddition2("Lettuce",0.30);
        System.out.println("Total burger price " + BasicHamburger.itemizeHamburger());

        com.danielmankovsky.src.com.danielmankovsky.HealthyBurger healthyBurger = new HealthyBurger("Bacon", 5.67);
        healthyBurger.addAddition1("Egg", 5.43);
        healthyBurger.addHealthAddition1("Lentils", 3.41);
        System.out.println("Total Healthy Burger price is  " + healthyBurger.itemizeHamburger());

        com.danielmankovsky.src.com.danielmankovsky.DeluxeBurger db = new DeluxeBurger();
